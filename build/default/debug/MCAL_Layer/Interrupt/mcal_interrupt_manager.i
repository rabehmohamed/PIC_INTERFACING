...
void __attribute__((picinterrupt(("")))) InterruptNoPriority(void){
    ...
    if((INTCONbits.RBIE == 1 ) && (INTCONbits.RBIF == 1) && (PORTBbits.RB4 == GPIO_HIGH) && (RB4_FLAG == 1)){
        RB4_FLAG=0;
        RB4_ISR(0);
    }
    else{}
    if((INTCONbits.RBIE == 1 ) && (INTCONbits.RBIF == 1) && (PORTBbits.RB4 == GPIO_LOW) && (RB4_FLAG == 0)){
        RB4_FLAG=1;
        RB4_ISR(1);
    }
    if((INTCONbits.RBIE == 1 ) && (INTCONbits.RBIF == 1) && (PORTBbits.RB5 == GPIO_HIGH) && (RB5_FLAG == 1)){
        RB5_FLAG=0;
        RB5_ISR(1);
    }
    else{}
    if((INTCONbits.RBIE == 1 ) && (INTCONbits.RBIF == 1) && (PORTBbits.RB5 == GPIO_LOW) && (RB5_FLAG == 0)){
        RB5_FLAG=1;
        RB5_ISR(0);
    }
    if((INTCONbits.RBIE == 1 ) && (INTCONbits.RBIF == 1) && (PORTBbits.RB6 == GPIO_HIGH) && (RB6_FLAG == 1)){
        RB6_FLAG=0;
        RB6_ISR(1);
    }
    else{}
    if((INTCONbits.RBIE == 1 ) && (INTCONbits.RBIF == 1) && (PORTBbits.RB6 == GPIO_LOW) && (RB6_FLAG == 0)){
        RB6_FLAG=1;
        RB6_ISR(0);
    }
    if((INTCONbits.RBIE == 1 ) && (INTCONbits.RBIF == 1) && (PORTBbits.RB7 == GPIO_HIGH) && (RB7_FLAG == 1)){
        RB7_FLAG=0;
        RB7_ISR(1);
    }
    else{}
    if((INTCONbits.RBIE == 1 ) && (INTCONbits.RBIF == 1) && (PORTBbits.RB7 == GPIO_LOW) && (RB7_FLAG == 0)){
        RB7_FLAG=1;
        RB7_ISR(0);
    }
